...
export class DemoComponent implements OnInit {
  ...
  employeeList: any = [
    ...
    { employeeId: 111, employeeName: "Rinky Nath", doj: "01-02-2016", highestQualification: "Higher Secondary" },
  ]
  ...
  createChartData() {
    ...
    this.employeeQualificationChart.data.push(["Higher Secondary", grouped.get("Higher Secondary").length])
